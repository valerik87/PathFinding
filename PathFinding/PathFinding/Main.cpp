...
//WinSreen
const static UINT32 SCREEN_SIZE_X = 810;
const static UINT32 SCREEN_SIZE_Y = 810;
	...
	while (m_oWindow.isOpen())
	{
		...
		while (m_oWindow.pollEvent(m_oEvent))
		{
			...
			if (sf::Mouse::isButtonPressed(sf::Mouse::Left))
			{
				...
				Logger::GetInstance().Log(Logger::SEVERITY::DEBUG, Logger::CONTEXT::MAIN, "Left Mouse Pressed in coord (%i,%i)", m_oLocalPosition.x, m_oLocalPosition.y);
